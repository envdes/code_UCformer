...
def get_2070data(parquetpath, bs):
    # 1. 读取标准化参数
    with open('/home/jiyang/scripts_/MT_test/train_statistics_v2.json', 'r') as f:
    ...
    cities = ['London', 'Newyork', 'Shanghai', 'Singapore', 'Rome', 'SaoP']
    dataloaders = {}
    ...
    return dataloaders, scaled_train_fea_max, scaled_train_lab_min, scaled_train_lab_max, train_lab_mean, train_lab_std
